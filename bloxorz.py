...
def next_position(pos, action, reverse_direction=False):
   ...
   if (reverse_direction == True): #this is for [(action, next_position(horiz1, action, True)) for action in ACTIONS]
       action = reverse_action_dict[action]
 
   
   if (pos[0] == pos[1]):  #this is for [(action, next_position(up0, action)) for action in ACTIONS]
       if (action == 'U'):
           y1 = pos[0][1] - 2
           y2 = pos[1][1] - 1
           x1 = pos[0][0]
   ...
   else:                    #this is for horiz0 & horiz1
       if (pos[0][1] == pos[1][1]):
           if (action == 'U'):
               y1 = pos[0][1] - 1
               y2= pos[1][1] - 1
               ...
               y1 = pos[0][1]
               y2 = pos[1][1]
       else:                      #this is for [(action, next_position(vert0, action)) for action in ACTIONS]
           if (action == 'U'):
               y1 = pos[0][1] - 1
               y2 = pos[1][1] - 2
               x1 = pos[0][0]
